...
class CSFramework extends CSFramework_Abstract {
  ...
  public function admin_page() {
    ...
    echo '<div class="cs-framework cs-option-framework">';
      ...
      echo '<h1>فارسی ساز نسیم <small>گروه طراحی نسیم نت</small></h1>';
      echo '<fieldset>';
      ...
      echo 'Nasim Persian Maker <strong>v'. CS_VERSION .' by <a style="color:#fff" href="http://nasimnet.ir" target="_blank">NasimNet</a></strong>';
